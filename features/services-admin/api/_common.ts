...
/**
 * Mirrors the gate pattern in features/site-settings-admin: when
 * TELEGRAM_BOT_TOKEN is unset (default CI / local dev), the admin pages
 * stay open so route-level tests work without secrets. The gate
 * activates the moment that env var lands in any environment.
 */
